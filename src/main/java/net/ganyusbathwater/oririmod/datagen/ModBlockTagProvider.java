...
public class ModBlockTagProvider extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
                ...
                tag(BlockTags.MINEABLE_WITH_PICKAXE)
                                ...
                                .add(ModBlocks.SCARLET_STONE_BRICKS.get())
                                .add(ModBlocks.CHISELED_SCARLET_STONE_BRICKS.get())
                                .add(ModBlocks.CRACKED_SCARLET_STONE_BRICKS.get())
                                .add(ModBlocks.MOSSY_SCARLET_STONE_BRICKS.get())
                                .add(ModBlocks.SCARLET_DEEPSLATE.get())
                                .add(ModBlocks.POLISHED_SCARLET_DEEPSLATE.get())
                                .add(ModBlocks.CHISELED_SCARLET_DEEPSLATE.get())
                                .add(ModBlocks.SCARLET_DEEPSLATE_BRICKS.get())
                                .add(ModBlocks.CRACKED_SCARLET_DEEPSLATE_BRICKS.get())
                                .add(ModBlocks.SCARLET_DEEPSLATE_TILES.get())
                                .add(ModBlocks.CRACKED_SCARLET_DEEPSLATE_TILES.get())
                                ...
                                .add(ModBlocks.MOSSY_SCARLET_COBBLESTONE.get())
                                ...
                                .add(ModBlocks.SCARLET_COBBLESTONE.get())
                                ...
                                .add(ModBlocks.SCARLET_STONE_BUTTON.get())
                                .add(ModBlocks.SCARLET_STONE_PRESSURE_PLATE.get())
                ...
                tag(BlockTags.MINEABLE_WITH_SHOVEL)
                                ...
                                .add(ModBlocks.SOL_QUICKSAND.get());
                ...
                tag(BlockTags.MINEABLE_WITH_HOE)
                                ...
                                .add(ModBlocks.HANGING_ELDER_MOSS.get())
