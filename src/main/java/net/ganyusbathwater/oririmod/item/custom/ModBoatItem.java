...
public class ModBoatItem extends Item {
    ...
    public ModBoatItem(boolean pHasChest, ModBoatEntity.ModBoatType pType, Properties pProperties) {
        super(pProperties);
    ...
    private Boat getBoat(Level pLevel, HitResult pHitResult) {
        if (this.hasChest) {
            ModChestBoatEntity chestboat = new ModChestBoatEntity(pLevel, pHitResult.getLocation().x, pHitResult.getLocation().y, pHitResult.getLocation().z);
            chestboat.setModVariant(this.type);
            return chestboat;
        } else {
            ModBoatEntity boat = new ModBoatEntity(pLevel, pHitResult.getLocation().x, pHitResult.getLocation().y, pHitResult.getLocation().z);
