...
public class ModItems {
        ...
        public static final DeferredItem<Item> MOON_STONE = ITEMS.register("moon_stone",
                        () -> new Item(new Item.Properties()));
        public static final DeferredItem<Item> DAMNED_SOUL = ITEMS.register("damned_soul",
                        () -> new Item(new Item.Properties()));
        ...
        public static final DeferredItem<Item> IRON_STICK = ITEMS.register("iron_stick",
                        () -> new Item(new Item.Properties()));
        public static final DeferredItem<Item> POWER_SOUL = ITEMS.register("power_soul",
                        () -> new Item(new Item.Properties()));
        ...
        public static final DeferredItem<VestigeItem> BOUND_OF_THE_CELESTIAL_SISTERS = ITEMS.register(
                        "bound_of_the_celestial_sisters",
                        () -> new BoundOfTheCelestialSisters(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> CANDY_BAG = ITEMS.register("candy_bag",
                        () -> new CandyBag(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> CRIT_GLOVE = ITEMS.register("crit_glove",
                        () -> new CritGlove(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> DUELLANT_CORTEX = ITEMS.register("duellant_cortex",
                        () -> new DuellantCortex(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> HEART_OF_THE_TANK = ITEMS.register("heart_of_the_tank",
                        () -> new HeartOfTheTank(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> MINERS_LANTERN = ITEMS.register("miners_lantern",
                        () -> new MinersLantern(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> MIRROR_OF_THE_VOID = ITEMS.register("mirror_of_the_void",
                        () -> new MirrorOfTheVoid(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> PHOENIX_FEATHER = ITEMS.register("phoenix_feather",
                        () -> new PhoenixFeather(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> RELIC_OF_THE_PAST = ITEMS.register("relic_of_the_past",
                        () -> new RelicOfThePast(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> SNOW_BOOTS = ITEMS.register("snow_boots",
                        () -> new SnowBoots(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> SOLIS_BROOCH = ITEMS.register("solis_brooch",
                        () -> new SolisBrooch(new Item.Properties().stacksTo(1)));
        public static final DeferredItem<VestigeItem> SPRING = ITEMS.register("spring",
        ...
        public static final DeferredItem<VestigeItem> STRIDER_SCALE = ITEMS.register("strider_scale",
                        () -> new StriderScale(new Item.Properties().stacksTo(1)));
        ...
        public static final DeferredItem<Item> BLOOD_LOTUS = ITEMS.register("blood_lotus",
                        () -> new BloodLotus(new Item.Properties().food(ModFoods.BLOOD_LOTUS)));
        public static final DeferredItem<Item> IRON_ROOTS = ITEMS.register("iron_roots",
                        () -> new IronRoots(new Item.Properties().food(ModFoods.IRON_ROOTS)));
        public static final DeferredItem<Item> MAGIC_MUSHROOM = ITEMS.register("magic_mushroom",
                        () -> new MagicMushroom(new Item.Properties().food(ModFoods.MAGIC_MUSHROOM)));
        public static final DeferredItem<Item> FLUORITE_CRYSTAL = ITEMS.register("fluorite_crystal",
                        () -> new Item(new Item.Properties()));
        public static final DeferredItem<Item> JADE = ITEMS.register("jade",
                        () -> new Item(new Item.Properties()));
        public static final DeferredItem<Item> FOUR_LEAF_CLOVER = ITEMS.register("four_leaf_clover",
                        () -> new FourLeafClover(new Item.Properties().food(ModFoods.FOUR_LEAF_CLOVER)));
        public static final DeferredItem<Item> MIRACLE_SEAWEED = ITEMS.register("miracle_seaweed",
                        () -> new MiracleSeaweed(new Item.Properties().food(ModFoods.MIRACLE_SEAWEED)));
        public static final DeferredItem<Item> CALCIUM_CURRANT = ITEMS.register("calcium_currant",
        ...
        public static final DeferredItem<Item> THE_FOOL = ITEMS.register("the_fool",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_MAGICIAN = ITEMS.register("the_magician",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_HIGH_PRIESTESS = ITEMS.register("the_high_priestess",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_EMPRESS = ITEMS.register("the_empress",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_EMPEROR = ITEMS.register("the_emperor",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_HIEROPHANT = ITEMS.register("the_hierophant",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_LOVERS = ITEMS.register("the_lovers",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_CHARIOT = ITEMS.register("the_chariot",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> STRENGTH = ITEMS.register("strength",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_HERMIT = ITEMS.register("the_hermit",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> WHEEL_OF_FORTUNE = ITEMS.register("wheel_of_fortune",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> JUSTICE = ITEMS.register("justice",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_HANGED_MAN = ITEMS.register("the_hanged_man",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> DEATH = ITEMS.register("death",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> TEMPERANCE = ITEMS.register("temperance",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_DEVIL = ITEMS.register("the_devil",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_TOWER = ITEMS.register("the_tower",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_STAR = ITEMS.register("the_star",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_MOON = ITEMS.register("the_moon",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> THE_SUN = ITEMS.register("the_sun",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
        public static final DeferredItem<Item> JUDGEMENT = ITEMS.register("judgement",
                        () -> new ModRarityItem(new Item.Properties(), ModRarity.MAGICAL));
