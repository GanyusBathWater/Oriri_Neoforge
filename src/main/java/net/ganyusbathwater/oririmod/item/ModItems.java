...
public class ModItems {
    ...
    public static final DeferredItem<VestigeItem> BOUND_OF_THE_CELESTIAL_SISTERS = ITEMS.register("bound_of_the_celestial_sisters", () -> new BoundOfTheCelestialSisters(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> CANDY_BAG = ITEMS.register("candy_bag", () -> new CandyBag(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> CRIT_GLOVE = ITEMS.register("crit_glove", () -> new CritGlove(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> DUELLANT_CORTEX = ITEMS.register("duellant_cortex", () -> new DuellantCortex(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> HEART_OF_THE_TANK = ITEMS.register("heart_of_the_tank", () -> new HeartOfTheTank(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> MINERS_LANTERN = ITEMS.register("miners_lantern", () -> new MinersLantern(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> MIRROR_OF_THE_VOID = ITEMS.register("mirror_of_the_void", () -> new MirrorOfTheVoid(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> PHOENIX_FEATHER = ITEMS.register("phoenix_feather", () -> new PhoenixFeather(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> RELIC_OF_THE_PAST = ITEMS.register("relic_of_the_past", () -> new RelicOfThePast(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> SNOW_BOOTS = ITEMS.register("snow_boots", () -> new SnowBoots(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> SOLIS_BROOCH = ITEMS.register("solis_brooch", () -> new SolisBrooch(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> SPRING = ITEMS.register("spring", () -> new Spring(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> STIGMA_OF_DARKNESS = ITEMS.register("stigma_of_darkness", () -> new StigmaOfDarkness(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> STRANGE_ENDER_EYE = ITEMS.register("strange_ender_eye", () -> new StrangeEnderEye(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> STRIDER_SCALE = ITEMS.register("strider_scale", () -> new StriderScale(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<VestigeItem> WITHER_ROSE = ITEMS.register("wither_rose", () -> new WitherRose(new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredItem<Item> DRAGON_FRUIT = ITEMS.register("dragon_fruit", () -> new DragonFruit(new Item.Properties().food(ModFoods.DRAGON_FRUIT)));
    public static final DeferredItem<Item> THE_FIRST_APPLE = ITEMS.register("the_first_apple", () -> new TheFirstApple(new Item.Properties().food(ModFoods.THE_FIRST_APPLE)));
    public static final DeferredItem<Item> BLOOD_LOTUS = ITEMS.register("blood_lotus", () -> new BloodLotus(new Item.Properties().food(ModFoods.BLOOD_LOTUS)));
    public static final DeferredItem<Item> IRON_ROOTS = ITEMS.register("iron_roots", () -> new IronRoots(new Item.Properties().food(ModFoods.IRON_ROOTS)));
    public static final DeferredItem<Item> MAGIC_MUSHROOM = ITEMS.register("magic_mushroom", () -> new MagicMushroom(new Item.Properties().food(ModFoods.MAGIC_MUSHROOM)));
    public static final DeferredItem<Item> FOUR_LEAF_CLOVER = ITEMS.register("four_leaf_clover", () -> new FourLeafClover(new Item.Properties().food(ModFoods.FOUR_LEAF_CLOVER)));
    public static final DeferredItem<Item> MIRACLE_SEAWEED = ITEMS.register("miracle_seaweed", () -> new MiracleSeaweed(new Item.Properties().food(ModFoods.MIRACLE_SEAWEED)));
    public static final DeferredItem<Item> CALCIUM_CURRANT = ITEMS.register("calcium_currant", () -> new CalciumCurrant(new Item.Properties().food(ModFoods.CALCIUM_CURRANT)));
    public static final DeferredItem<Item> DEVIL_FRUIT = ITEMS.register("devil_fruit", () -> new DevilFruit(new Item.Properties().food(ModFoods.DEVIL_FRUIT)));

    //---------------------------------------Weapons---------------------------------------------------------

    public static final DeferredItem<SwordItem> PANDORAS_BLADE = ITEMS.register("pandoras_blade", () -> new CustomSwordItem(Tiers.DIAMOND, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 3, -2.4F)).stacksTo(1), ModRarity.MYTHIC));
    public static final DeferredItem<SwordItem> PIRATE_SABER = ITEMS.register("pirate_saber", () -> new CustomSwordItem(Tiers.IRON, new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 3, -1F)).stacksTo(1), ModRarity.UNCOMMON));
    public static final DeferredItem<SwordItem> ICE_SWORD = ITEMS.register("ice_sword", () -> new CustomSwordItem(Tiers.DIAMOND, new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 3, -2.4F)).stacksTo(1), ModRarity.RARE));
    public static final DeferredItem<MaceItem> LAW_BREAKER = ITEMS.register("law_breaker", () -> new CustomHammerItem(new Item.Properties().fireResistant().stacksTo(1).attributes(MaceItem.createAttributes()), ModRarity.GODLY));
    public static final DeferredItem<SwordItem> STELLA_PERDITOR = ITEMS.register("stella_perditor", () -> new CustomSwordItem(Tiers.NETHERITE, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(Tiers.NETHERITE, 6,-1.4F)).stacksTo(1), ModRarity.UNIQUE));
    public static final DeferredItem<SwordItem> QILINS_WRATH = ITEMS.register("qilins_wrath", () -> new CustomSwordItem(Tiers.NETHERITE, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(Tiers.NETHERITE, 6, -1.4F)).stacksTo(1),ModRarity.GODLY));
    public static final DeferredItem<SwordItem> SOLS_EMBRACE = ITEMS.register("sols_embrace", () -> new CustomSwordItem(Tiers.DIAMOND, new Item.Properties().fireResistant().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 3, -2.4F)).stacksTo(1), ModRarity.LEGENDARY));

    public static final DeferredItem<PickaxeItem> NEBULA_PICKAXE = ITEMS.register("nebula_pickaxe", () -> new CustomPickaxeItem(Tiers.NETHERITE, new Item.Properties().attributes(PickaxeItem.createAttributes(Tiers.NETHERITE, 1, -2.8F)).stacksTo(1), ModRarity.LEGENDARY));
    public static final DeferredItem<PickaxeItem> MOLTEN_PICKAXE = ITEMS.register("molten_pickaxe", () -> new CustomPickaxeItem(Tiers.DIAMOND, new Item.Properties().attributes(PickaxeItem.createAttributes(Tiers.DIAMOND, 1, -2.8F)).stacksTo(1), ModRarity.RARE));
    public static final DeferredItem<MaceItem> MJOELNIR = ITEMS.register("mjoelnir", () -> new CustomHammerItem(new Item.Properties().attributes(MaceItem.createAttributes()).stacksTo(1), ModRarity.MYTHIC));

    public static final DeferredItem<CrossbowItem> ARBITER_CROSSBOW = ITEMS.register("arbiter_crossbow", () -> new CustomCrossbowItem(new Item.Properties().stacksTo(1), ModRarity.LEGENDARY));
    public static final DeferredItem<BowItem> ORAPHIM_BOW = ITEMS.register("oraphim_bow", () -> new CustomBowItemClass(new Item.Properties().stacksTo(1), ModRarity.LEGENDARY));

    public static final DeferredItem<SwordItem> EMERALD_SWORD = ITEMS.register("emerald_sword", () -> new SwordItem(Tiers.DIAMOND, new Item.Properties().stacksTo(1).fireResistant().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 3, -2.4F))));
    public static final DeferredItem<AxeItem> EMERALD_AXE = ITEMS.register("emerald_axe", () -> new AxeItem(Tiers.DIAMOND, new Item.Properties().stacksTo(1).fireResistant().attributes(AxeItem.createAttributes(Tiers.DIAMOND, 5.0F, -3.0F))));
    public static final DeferredItem<PickaxeItem> EMERALD_PICKAXE = ITEMS.register("emerald_pickaxe", () -> new PickaxeItem(Tiers.DIAMOND, new Item.Properties().stacksTo(1).fireResistant().attributes(PickaxeItem.createAttributes(Tiers.DIAMOND, 1.0F, -2.8F))));
    public static final DeferredItem<ShovelItem> EMERALD_SHOVEL = ITEMS.register("emerald_shovel", () -> new ShovelItem(Tiers.DIAMOND, new Item.Properties().stacksTo(1).fireResistant().attributes(ShovelItem.createAttributes(Tiers.DIAMOND, 1.5F, -3.0F))));
    public static final DeferredItem<HoeItem> EMERALD_HOE = ITEMS.register("emerald_hoe", () -> new HoeItem(Tiers.DIAMOND, new Item.Properties().stacksTo(1).fireResistant().attributes(HoeItem.createAttributes(Tiers.DIAMOND, -3.0F, 0.0F))));

    public static final DeferredItem<MagicStaffItem> STAFF_OF_WISE = ITEMS.register("staff_of_wise", () -> new MagicStaffItem(new Item.Properties().stacksTo(1), MagicStaffItem.StaffAction.REGEN, 400, 0,500, 20, ModRarity.MYTHIC));
    public static final DeferredItem<MagicStaffItem> STAFF_OF_EARTH = ITEMS.register("staff_of_earth", () -> new MagicStaffItem(new Item.Properties().stacksTo(1), MagicStaffItem.StaffAction.HASTE, 400, 1,600, 12, ModRarity.RARE));
    public static final DeferredItem<MagicStaffItem> STAFF_OF_FOREST = ITEMS.register("staff_of_forest", () -> new MagicStaffItem(new Item.Properties().stacksTo(1), MagicStaffItem.StaffAction.GROW, 0, 0, 20, 6, ModRarity.UNCOMMON));

    public static final DeferredItem<MagicBoltItem> ONE_THOUSAND_SCREAMS = ITEMS.register("one_thousand_screams", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.SONIC, 2, 12, ModRarity.MYTHIC));
    public static final DeferredItem<MagicBoltItem> STAFF_OF_HELL = ITEMS.register("staff_of_hell", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.BLAZE, 2, 8, ModRarity.RARE));
    public static final DeferredItem<MagicBoltItem> STAFF_OF_COSMOS = ITEMS.register("staff_of_cosmos", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.METEOR, 2, 40, ModRarity.LEGENDARY));
    public static final DeferredItem<MagicBoltItem> STAFF_OF_VOID = ITEMS.register("staff_of_void", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.ENDER, 2, 18, ModRarity.MYTHIC));
    public static final DeferredItem<MagicBoltItem> DODOCO = ITEMS.register("dodoco", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.EXPLOSIVE, 2, 20, ModRarity.RARE));
    public static final DeferredItem<MagicBoltItem> BOOK_OF_AMATEUR = ITEMS.register("book_of_amateur", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.NORMAL, 2, 4, ModRarity.COMMON));
    public static final DeferredItem<MagicBoltItem> BOOK_OF_APPRENTICE = ITEMS.register("book_of_apprentice", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.NORMAL, 2, 6, ModRarity.UNCOMMON));
    public static final DeferredItem<MagicBoltItem> BOOK_OF_JOURNEYMAN = ITEMS.register("book_of_journeyman", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.NORMAL, 2, 10, ModRarity.RARE));
    public static final DeferredItem<MagicBoltItem> BOOK_OF_WISE = ITEMS.register("book_of_wise", () -> new MagicBoltItem(new Item.Properties().stacksTo(1), MagicBoltAbility.NORMAL, 2, 16, ModRarity.MYTHIC));
    public static final DeferredItem<OmniMagicItem> STAFF_OF_ALMIGHTY = ITEMS.register("staff_of_almighty", () -> new OmniMagicItem(new Item.Properties().stacksTo(1), ModRarity.GODLY, 2, 500, 1));
