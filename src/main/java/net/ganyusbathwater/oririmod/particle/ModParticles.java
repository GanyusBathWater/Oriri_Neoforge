...
public class ModParticles {
    ...
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> TELEPORTER_VORTEX_PARTICLE = PARTICLE_TYPES
            .register("teleporter_vortex", () -> new SimpleParticleType(true));
