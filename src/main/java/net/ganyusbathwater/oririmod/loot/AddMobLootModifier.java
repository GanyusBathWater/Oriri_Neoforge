...
public class AddMobLootModifier extends LootModifier {
    public static final MapCodec<AddMobLootModifier> CODEC = RecordCodecBuilder.mapCodec(inst ->
            codecStart(inst).and(
    ...
    public AddMobLootModifier(LootItemCondition[] conditionsIn, ResourceKey<LootTable> table) {
        super(conditionsIn);
        this.table = table;
    }
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        // Ensure that the drop is from a Mob (monsters, animals, etc.), not a block or the player
    ...
    public MapCodec<? extends IGlobalLootModifier> codec() {
        return ModLootModifiers.ADD_MOB_LOOT.get();
    }
}
